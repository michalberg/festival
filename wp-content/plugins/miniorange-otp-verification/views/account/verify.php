...
echo'	<!-- Enter otp --><div class="mo_registration_divided_layout">
				...
				<div class="mo_registration_table_layout">
					<table class="mo_registration_settings_table">
						...
						<tr>
							...
							<td colspan="3"><input class="mo_registration_table_textbox" autofocus="true" type="text" name="otp_token" required placeholder="Enter OTP" style="width:40%;" title="Only 6 digit numbers are allowed"/>
		...
		<form id="phone_verification" method="post" action="">
			<input type="hidden" name="option" value="mo_registration_phone_verification" />
			 ...
			 <br><br>
				...
				<tr>
				<td colspan="3">
				<input class="mo_registration_table_textbox" required  pattern="[0-9\+]{12,18}" autofocus="true" style="width:100%;" type="tel" name="phone_number" id="phone" placeholder="Enter Phone Number" value="'.$admin_phone.'" title="Enter phone number(at least 10 digits) without any space or dashes."/>
				</td>
				<td>&nbsp;&nbsp;
