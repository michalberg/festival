			...
			<p>Need any help? Just send us a query so we can help you.</p>
				<form name="f" method="post" action="">
					...
					<table class="mo_registration_settings_table">
						<tr><td>
							<input type="email" class="mo_registration_table_textbox" id="query_email" name="query_email" value="'.$email.'" placeholder="Enter your email" required />
							</td>
						</tr>
						<tr><td>
							<input type="text" class="mo_registration_table_textbox" name="query_phone" id="query_phone" value="'.$phone.'" placeholder="Enter your phone"/>
							</td>
						</tr>
						<tr>
							<td>
								<textarea id="query" name="query" class="mo_registration_settings_textarea" style="resize: vertical;width:100%" cols="52" rows="7" onkeyup="mo_registration_valid_query(this)" onblur="mo_registration_valid_query(this)" onkeypress="mo_registration_valid_query(this)" placeholder="Write your query here"></textarea>
							</td>
						</tr>
					</table>
